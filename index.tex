...
\label{sec:org0161d36}
\subsubsection{Einhorn\label{einhorn}}
\label{sec:org229adff}
...
\label{sec:org02a3548}
\subsubsection{Yeti\label{yeti}}
\label{sec:orga812522}
...
\textbf{STR} & \textbf{DEX} & \textbf{CON} & \textbf{INT} & \textbf{WIS} & \textbf{CHA}\\[0pt]
\hline
17(+3) & 12(+1) & 14(+2) & 6(-2) & 13(+1) & 6(-2)\\[0pt]
\end{tabular}
\end{center}


\subsubsection{Werwölfe\label{werwolf}}
\label{sec:org19f63bd}
...
\subsection{Eversonn}
\label{sec:org9e012b7}
\subsubsection{Phönix\label{phönix}}
\label{sec:org0ac7146}
...
\label{sec:org3b1861f}
\subsubsection{Garuda\label{garuda}}
\label{sec:org62ff3aa}
